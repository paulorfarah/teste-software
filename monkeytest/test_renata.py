...
ap.add_argument("-lp", "--logpath", default=_D_LOGPATH,
                help="Path do log dos operadores dos mutantes gerado pelo MDroidPlus")
...
def main():
    ...
    for k in grupo:
        ...
        logging.info('Operador: ' + k + ";VIVOS: " + str(grupo[k]['vivo']) + ";MORTOS: " + str(
